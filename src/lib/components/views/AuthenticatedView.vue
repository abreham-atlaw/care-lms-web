...
import AuthRepository from "@/apps/auth/data/repositories/authRepository";
...
export default defineComponent({
	props: {
		validStatus: {
			type: Array,
			default: () => [AuthenticationStatus.authenticated, AuthenticationStatus.consumer]
		},
		redirectionMap: {
			type: Map,
			default: () => new Map()
